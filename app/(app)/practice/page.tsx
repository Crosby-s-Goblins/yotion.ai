...
export default function PracticePage() {
  return (
    <main className="flex flex-col items-center justify-center w-full md:h-screen md:items-center 2xl:h-screen 2xl:items-center">
        <div>
            <h1 className="text-3xl font-semibold my-10 my-5"><a href='/'>yotion.ai</a></h1>
        </div>
