...
export default function PracticePage() {
  return (
    <main className="flex flex-col items-center justify-center w-full 2xl:h-screen 2xl:items-center">
        <div>
            <h1 className="text-3xl font-semibold my-10 my-5">yotion.ai</h1>
        </div>
